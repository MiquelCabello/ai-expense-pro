...
CREATE TABLE public.account_departments (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  account_id uuid NOT NULL,
  name text NOT NULL,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT account_departments_pkey PRIMARY KEY (id),
  CONSTRAINT account_departments_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.accounts(id)
);
CREATE TABLE public.accounts (
  ...
  department_admin_limit integer,
...
CREATE TABLE public.profiles (
  ...
  name text NOT NULL,
  role USER-DEFINED NOT NULL DEFAULT 'EMPLOYEE'::user_role CHECK (role = ANY (ARRAY['ADMIN'::user_role, 'EMPLOYEE'::user_role])),
  department text,
  region text,
  ...
  CONSTRAINT profiles_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.account_departments(id)
);
...
CREATE TABLE public.user_roles (
  ...
  CONSTRAINT user_roles_account_id_fkey FOREIGN KEY (account_id) REFERENCES public.accounts(id),
  CONSTRAINT user_roles_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.account_departments(id),
