...
-- 3. Eliminar tablas del sistema antiguo (CASCADE para eliminar dependencias)
...
-- 4. Eliminar tipos enum del sistema antiguo
...
-- =====================================================
-- Sistema limpio - Solo tablas nuevas permanecen
-- =====================================================